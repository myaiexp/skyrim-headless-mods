class DialogueMenu extends MovieClip
{
   ...
   function DialogueMenu()
   {
      ...
      _loc4_.load("UntarnishedUI/buttonart_config.txt");
      _loc4_.onData = function(str)
      {
         DialogueMenu.PS_BUTTONS = DialogueMenu.ParseConfig(str,"bDialogueMenuPS");
      };
   }
   ...
   {
      if(DialogueMenu.PS_BUTTONS == "true" && aiPlatform == 1)
      {
         aiPlatform = 3;
      }
   ...
   function ShowDialogueList(abSlideAnim, abCopyVisible)
   {
      ...
      this.topicsFadeIn();
      this.TopicListHolder.gotoAndPlay(!abSlideAnim ? "fadeListIn" : "fadeListIn");
