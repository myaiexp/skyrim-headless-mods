...
| `docs/skse-tier-bringup.md`      | Headless **SKSE C++** tier bring-up (CommonLibSSE-NG cross-compiled on Linux) for engine-level control Papyrus can't reach. **Done** — realized as `plugins/AutoFireBow` + `GhostAllies`; kept as historical reference.                                                                                                                                                                                                              |
