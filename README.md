...
arrows and aimed spells pass harmlessly through your whole party.
...
| `mods/GhostAllies/`              | **The flagship: working SKSE C++ mod (v0.9.0), verified in-game.** Player arrows + aimed spells pass _through_ your whole party to hit the enemy behind; the player's hostile magic deals no friendly damage to teammates. Full write-up (mechanisms, limitations, build) in the mod **`README.md`**; design in `docs/plans/ghost-allies-{design,v2-plan}.md`.                                                                                                                                                                                                                                                                                                                                                                     |
