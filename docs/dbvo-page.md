...
Built on **[Dragonborn Voice Over](https://www.nexusmods.com/skyrimspecialedition/mods/84329)** by MathiewMay, with permission received from the author. The bundled `dialoguemenu.swf` is DBVO's asset recompiled with these tweaks. All credit for DBVO goes to MathiewMay.
